...
public class ProductController {
    ...
    /**
     * 제품을 구매합니다. body가 없으면 현재 사용자의 장바구니에 담긴 모든 제품을 구매합니다. body가 있으면 해당 제품을 구매합니다. 재고 차감 후 임계값 도달 시 Kafka로 알림 이벤트를
     * 발행합니다.
     */
    @Operation(
            summary = "제품 구매",
            ...
            @ApiResponse(responseCode = "200", description = "구매 성공",
                    content = {
                            @Content(mediaType = "application/json",
                                    schema = @Schema(oneOf = {PurchaseProductResponse.class,
                                            PurchaseCartResponse.class}))
                    }),
